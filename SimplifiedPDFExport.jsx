...
const SimplifiedPDFExport = () => {
  ...
  const generatePDF = async () => {
    ...
    try {
      ...
      pdf.setProperties({
        title: `RuM Project Proposal - ${proposal.sections.titlePage?.customerName || 'Customer'}`,
        subject: proposal.sections.titlePage?.subtitle || 'Project Proposal',
        author: 'RuM Project GmbH',
        keywords: 'proposal, project, construction',
        creator: 'RuM Project Proposal Generator'
      });
...
export default SimplifiedPDFExport;
